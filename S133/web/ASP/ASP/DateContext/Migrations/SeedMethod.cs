        ...
        public static void CategoryandProductSeed(ProductDBcontext context)
        {
            ...
            for(var i = 0; i < 100; i++)
            {
                var p1 = new Product()
                {
                    ...
                    SN = c1.Name + i.ToString("00") + "用了就知道好！",
                };
            ...
            for (var i = 0; i < 100; i++)
            {
                var p2 = new Product()
                {
                    ...
                    SN = c2.Name + i.ToString("00") + "用了就知道好！",
                };
            ...
            for (var i = 0; i < 100; i++)
            {
                var p3 = new Product()
                {
                    ...
                    SN = c3.Name + i.ToString("00") + "用了就知道好！",
                };
            ...
            for (var i = 0; i < 100; i++)
            {
                var p4 = new Product()
                {
                    ...
                    SN = c4.Name + i.ToString("00") + "用了就知道好！",
                };
            ...
            for (var i = 0; i < 100; i++)
            {
                var p5 = new Product()
                {
                    ...
                    SN = c5.Name + i.ToString("00") + "用了就知道好！",
                };
            ...
            for (var i = 0; i < 100; i++)
            {
                var p6 = new Product()
                {
                    ...
                    SN = c6.Name + i.ToString("00") + "用了就知道好！",
                };
